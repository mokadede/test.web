...
<head>
    ...
    <style>
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        /* WORKSHOPS */
        .workshops { padding: 100px 1.5rem; background: var(--surface); border-top: 1px solid rgba(255,255,255,0.05); }
        .workshop-grid { display: grid; grid-template-columns: repeat(2, 1fr); gap: 2.5rem; max-width: 1000px; margin: 3rem auto 0; text-align: left; }
        ...
        .workshop-card h3 { font-size: 1.3rem; font-weight: 800; margin-bottom: 0.75rem; text-transform: uppercase; color: var(--white); }
        ...
        .workshop-time { font-size: 0.85rem; font-weight: 700; line-height: 1.4; color: var(--white); }
