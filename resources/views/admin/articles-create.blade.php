<x-app-layout title="Tulis Artikel Baru">
    <x-slot name="header">
            ...
            <form id="article-form" method="POST" action="{{ route('admin.articles.store') }}" enctype="multipart/form-data">
                ...
                <div class="bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-gray-200 dark:border-gray-700 p-6 mb-6">
                    <label class="flex items-center gap-3 cursor-pointer">
                        ...
                        <span class="text-sm text-gray-700 dark:text-gray-300">Terbitkan artikel ini sekarang</span>
                    </label>
                </div>
    ...
    <script>
        ...
        function initEditor() {
            ...
            // Wait for EditorJS core to load
            if (typeof EditorJS === 'undefined') {
                ...
                holder.innerHTML = '<p style="padding:1.5rem;color:#ef4444;text-align:center;">Gagal memuat editor. Pastikan koneksi internet stabil lalu <a href="" style="text-decoration:underline;">segarkan halaman</a>.</p>';
                return;
            }

            // Build tools config dynamically based on what loaded
            const tools = {};
