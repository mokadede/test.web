<x-app-layout title="Manajemen Pesanan">
 ...
 <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 space-y-6">
        ...
        <div class="p-6 bg-white dark:bg-gray-800 shadow sm:rounded-lg" x-data>
            <form id="filterForm" method="GET" action="{{ route('admin.orders') }}" class="flex flex-wrap items-end gap-4" x-ref="form">
                ...
                <div class="flex gap-2">
                    <button type="submit" class="px-4 py-2 bg-indigo-600 hover:bg-indigo-700 text-white text-sm font-semibold rounded-md shadow transition flex items-center gap-2">
                        <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M21 21l-6-6m2-5a7 7 0 11-14 0 7 7 0 0114 0z"></path></svg>
                        Cari
                    </button>
                    @if(request()->anyFilled(['search', 'start_date', 'end_date']))
                        <a href="{{ route('admin.orders') }}" class="px-4 py-2 bg-gray-200 dark:bg-gray-700 text-gray-700 dark:text-gray-200 text-sm font-semibold rounded-md shadow transition">
                            Reset
                        </a>
                    @endif
                </div>
